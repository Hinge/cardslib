...
/**
 * Card List View. It uses an {@link CardArrayAdapter} to populate items. </p>
 * Usage:
 * 
 * <pre>
 * <code>
 ...
 * layout. </p> Use this code to populate the list view
 * 
 * <pre>
 * <code>
 ...
 * </pre>
 * 
 * </p> Currently you have to use the same inner layout for each card in
 * listView. </p>
 * 
 * @author Gabriele Mariotti (gabri.mariotti@gmail.com)
 */
public class CardListView extends NoScrollListView implements
...
//			float diff_y = Math.abs(ev.getY() - old_y);
//			float diff_x = Math.abs(ev.getX() - old_x);
//			 
////			if (diff_x > diff_y) {
////				return super.dispatchTouchEvent(ev);
////			}  
////			if (ev.getY() != old_y && diff_y < diff_x) {
////				old_y = ev.getY();
////				return false;
////			}
//			//
...
//	}
	...
	/**
	 * Set the adapter. You can provide a {@link CardArrayAdapter}, or a
	 * {@link it.gmariotti.cardslib.library.internal.CardCursorAdapter} or a
	 * generic adapter. Pay attention: your generic adapter has to call
	 * {@link CardArrayAdapter#getView} method
	 * 
	 * @param adapter
	 */
	@Override
	public void setAdapter(ListAdapter adapter) {
		if (adapter instanceof CardArrayAdapter) {
			...
			Log.e(TAG,
					"You are using a generic adapter. Pay attention: your adapter has to call cardArrayAdapter#getView method");
	 ...
	 *            {@link CardArrayAdapter} cardArrayAdapter
	 */
	 ...
	 *            {@link CardCursorAdapter} cardArrayAdapter
	 */
	public void setExternalAdapter(ListAdapter adapter,
			CardCursorAdapter cardCursorAdapter) {
	...
	private void prepareExpandView(final CardView view,
				...
				s.addListener(new AnimatorListenerAdapter() {
					...
					public void onAnimationEnd(Animator animation) {
						...
						if (card.getOnExpandAnimatorEndListener() != null)
							card.getOnExpandAnimatorEndListener().onExpandEnd(
									card);
					}
				});
				s.start();
	...
	private void prepareCollapseView(final CardView view,
			final View expandingLayout) {
		final Card card = (Card) getItemAtPosition(getPositionForView(view));
		...
		view.setLayoutParams(new AbsListView.LayoutParams(
				AbsListView.LayoutParams.MATCH_PARENT, view
						.getCollapsedHeight()));
